...
interface ApiClient {
    ...
    @GET("everything?q={search} news&sortBy=publishedAt&apiKey=2890a5db9eb84ba09f6880b22c992edc")
    fun getViaSearchData(@Query("search") search:String):Call<ResponseModel>
}